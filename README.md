...
* [`src/sudoku/`](src/sudoku/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/sudoku/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `sudoku` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/sudoku/config.cljs) defaults to `true` in
...
```clj
(ns sudoku.example
  (:require [sudoku.config :as config])
